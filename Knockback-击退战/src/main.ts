...
import { makeKnockbackHooks } from "./game";

import { getKnockbackConfig, loadKnockbackConfig } from "./knockback-config";
...
world.afterEvents.worldLoad.subscribe(() => {
  ...
  runtime.config.prepSpawn = getKnockbackConfig().prepSpawn;
