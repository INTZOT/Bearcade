...
import { initPillarsCommands, initPillarsEvents, makePillarsHooks } from "./game";
...
runtime = new MinigameRuntime(

  {
    ...
    // 离开/断线由玩法自行按“淘汰”处理,不让共享运行时在人数低于 min 时立刻结束

    endGameWhenBelowMin: false,

  },

  makePillarsHooks(() => runtime),

);



initPillarsCommands(runtime);
